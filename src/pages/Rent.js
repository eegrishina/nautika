        ...
        <div className='container'>
            ...
            <YachtDetail
                details={[
                    {
                        id: 1,
                        info: '«Луч» — олимпийский класс яхт, рассчитанный на одного человека, который занимается и управлением яхтой, и настройкой паруса.',
                        list: [
                            'Длина корпуса: 4 м',
                    ...
                    {
                        id: 2,
                        info: '«Солинг» — класс яхт, предназначенный для пяти человек, на которой капитан занимается  управлением яхтой, а экипаж помогает с настройкой паруса.',
                        list: [
                            'Длина корпуса: 10 м',
                    ...
                    {
                        id: 3,
                        info: '«Финн» — класс яхт, предназначенный для двоих человек, либо для управления одним человеком с достаточной массой тела.',
                        list: [
                            'Длина корпуса: 4 м',
